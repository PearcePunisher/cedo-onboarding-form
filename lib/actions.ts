  ...
  try {
    ...
    await sql`
      INSERT INTO onboarding_submissions (
        ...
        f1_include_support_series,
        f1_include_sprint,
        f1_acknowledge_schedule_source,
        imsa_include_michelin_pilot,
        imsa_weather_tech_only,
        imsa_acknowledge_schedule_source,
        nascar_include_xfinity,
        nascar_include_truck_series,
        nascar_acknowledge_schedule_source,
        nhra_include_sportsman,
        nhra_pro_only,
        nhra_acknowledge_schedule_source,
        event_types,
        use_default_faqs,
        special_notes,
        assets_approved,
        ...
        ${data.teamBackground},
        ${JSON.stringify(data.selectedSeries)},
        ${data.indycarOnly},
        ${data.includeIndycarNxt},
        ${data.acknowledgeScheduleSource},
        ${data.f1IncludeSupportSeries},
        ${data.f1IncludeSprint},
        ${data.f1AcknowledgeScheduleSource},
        ${data.imsaIncludeMichelinPilot},
        ${data.imsaWeatherTechOnly},
        ${data.imsaAcknowledgeScheduleSource},
        ${data.nascarIncludeXfinity},
        ${data.nascarIncludeTruckSeries},
        ${data.nascarAcknowledgeScheduleSource},
        ${data.nhraIncludeSportsman},
        ${data.nhraProOnly},
        ${data.nhraAcknowledgeScheduleSource},
